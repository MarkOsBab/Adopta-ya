...
box-shadow: 0px 0px  60px  20px  rgba(100,222,106,0.5);
-webkit-transition: all 0.5s;
  transition: all 0.5s;
}
...
box-shadow: 0px 0px 60px 10px rgba(95, 156, 214, 0.5),0px 0px  20px  0px  rgba(0,0,0,0.1);
  z-index:5;
transition: all 0.5s;
-webkit-transition: all 0.5s;
}
...
<h1 class="w3-text-light-blue">Error 403</h1>  
  <p>No se pudo encontrar esta página</p>
  <a href="/"><i class="fal fa-home"></i> Volver al inicio</a>
  </div>

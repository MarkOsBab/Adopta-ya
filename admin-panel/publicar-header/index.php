        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Añadir header</h4>
                  <p class="card-description"> Porfavor completa todos los campos correctamente. </p>
                  <div class="table-responsive">
                    <table class="table">
                      <?php if (empty($_GET['edit_header'])) { ?>
                      <form class="forms-sample" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Titulo del header</label>
                              <div class="col-sm-10">
                                <input type="text" class="form-control" name="titulo_header" />
                              </div>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Contenido del header</label>
                              <div class="col-sm-10">
                                <textarea type="text" class="form-control" name="contenido_header"/></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Contenido del header</label>
                              <div class="col-sm-10">
                                <select class="form-control" name="show_for">
                                  <option selected value="0">Nadie</option>
                                  <option value="1">Todos</option>
                                  <option value="2">Interes perros</option>
                                  <option value="3">Interes gatos</option>
                                </select>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Imágen del header</label>
                              <div class="col-sm-10">
                                <input type="file" name="image_header" class="file-upload-default">
                          ...
                          <div class="col-md-12">
                            <input type="submit" onclick="myFunction()" class="btn btn-primary" value="Añadir header" name="add_header">
                      ...
                      $busca_header_data = $db->prepare("SELECT * FROM cms_home_headers WHERE id='$header_id'");
                      $busca_header_data->execute();
                      $result_header_data = $busca_header_data->fetchAll();
                          foreach ($result_header_data as $row) {
                              $Titulo = $row['Titulo'];
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Titulo del header</label>
                              <div class="col-sm-10">
                                <input type="text" class="form-control" name="edit_titulo_header" value="<?php echo $Titulo; ?>" />
                              </div>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Contenido del header</label>
                              <div class="col-sm-10">
                                <textarea type="text" class="form-control" name="edit_contenido_header"/><?php echo $Content; ?></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Visible para</label>
                              <div class="col-sm-10">
                                <?php switch ($Show_For) {
                                  case 0:
                                    $result = '
                                    <select class="form-control" name="edit_show_for">
                                      <option selected value="0">Nadie</option>
                                      <option value="1">Todos</option>
                                      <option value="2">Interes perros</option>
                                      <option value="3">Interes gatos</option>
                                  ...
                                  case 2:
                                    ...
                                    <select class="form-control" name="edit_show_for">
                                      <option value="0">Nadie</option>
                                      <option value="1">Todos</option>
                                      <option selected value="2">Interes perros</option>
                                      <option value="3">Interes gatos</option>
                                    </select>';
                                    break;
                                  case 3:
                                    ...
                                    <select class="form-control" name="edit_show_for">
                                      ...
                                      <option value="1">Todos</option>
                                      <option value="2">Interes perros</option>
                                      <option selected value="3">Interes gatos</option>
                                    </select>';
                                    break;
                                } echo $result; ?>
                              </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Imágen del header</label>
                              <div class="col-sm-10">
                                <input type="file" name="edit_image_header" class="file-upload-default">
                                <div class="input-group col-xs-12">
                                  <input type="text" class="form-control file-upload-info" disabled value="<?php echo $Imagen; ?>" placeholder="Upload Image">
                                  <span class="input-group-append">
                                    <button class="file-upload-browse btn btn-primary" type="button">Upload</button>
                                  </span>
                                </div>
                          ...
                          <div class="col-md-12">
                            <input type="submit" onclick="myFunction()" class="btn btn-primary" value="Editar header" name="edit_header">
                            <a class="btn btn-dark" href="../inicio">Cancelar</a>
                          </div>
                        </div>
                      </form>

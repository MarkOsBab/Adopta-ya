          ...
          <div class="content-wrapper">
            ...
            <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Publicaciones a contactar</h4>
          	...
          	<div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div id="donations_content">
                   		<?php 
                   		$db = getDB();
                   		require_once 'paginacion_donaciones.php';
                   		?>
                   	</div>
                   		<nav class="mt-3">
							<ul class="pagination justify-content-center">
								...
								if ($total > 0) {
									for($n = 1; $n <= $paginas; $n++) {
										echo '<li class="page-item "><a onclick="Pagina_s('.$n.')" class="btn btn-rounded btn-outline-info">'.$n.'</a></li>';
									}
								}
								?>
							</ul>

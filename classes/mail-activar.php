<?php 
$activar = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
				    ...
				    <tr>
				      <td valign='top' class='specbundle'><div class='contentEditableContainer contentTextEditable'>
				                                <div class='contentEditable'>
				                                	<center>
				                                		<img src='https://adoptaya.com/templates/static/images/logo_test.png' width='150'>
				                                	</center>
				                                </div>
				                              </div></td>
				    </tr>
				        	...
				        	<table width='100%' border='0' cellspacing='0' cellpadding='0' align='center'>
				                            ...
				                            <td align='left'>
				                              <div class='contentEditableContainer contentTextEditable'>
				                                <div class='contentEditable' align='center'>
				                                  <h2 >Bienvenido a Adopta ¡YA! ". $Nombre ." ". $Apellido."</h2>
				                                </div>
				                              </div>
				                            </td>
				                          </tr>
				                          ...
				                          <tr>
				                            <td align='left'>
				                              <div class='contentEditableContainer contentTextEditable'>
				                                <div class='contentEditable' align='center'>
				                                  <p >
				                                    Gracias por ser parte de esta comunidad que ayuda a los animales a encontrar el cálido hogar que se merecen. A continuación te dejamos el link para activar tu cuenta así podrás comenzar a publicar mascotas en adopción o comenzar a buscar tu mascota perdida.
				                                    <br>
				                                    <br>
				                                    Coordialmente,
				                                    <br>
				                                    <span style='color:#222222;'>Adopta ¡YA!</span>
				                          ...
				                          <tr>
				                            <td align='center'>
				                              <table>
				                                <tr>
				                                  <td align='center' bgcolor='#1A54BA' style='background:#A93226; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
				                                    <div class='contentEditableContainer contentTextEditable'>
				                                      <div class='contentEditable' align='center'>
				                                        <a target='_blank' href='https://adoptaya.com/registro/?reg=".$token_registro."&mail=".$Correo."' class='link2' style='color:#ffffff;'>Activa tu cuenta</a>
				                                      </div>
				                                    </div>
				                                  </td>
				                                </tr>

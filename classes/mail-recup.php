<?php 
$recup = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
				                          ...
				                          <tr>
				                            <td align='left'>
				                              <div class='contentEditableContainer contentTextEditable'>
				                                <div class='contentEditable' align='center'>
				                                  <p >
				                                    Gracias por mantener la calma y esperar a que te ayudemos! A continuación deberás dar click en recuperar contraseña para cambiar la contraseña.
				                                    <br>
				                                    <br>
				                                    Coordialmente,
				                                    <br>
				                              ...
				                              <table>
				                                <tr>
				                                  <td align='center' bgcolor='#1A54BA' style='background:#A93226; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
				                                    <div class='contentEditableContainer contentTextEditable'>
				                                      <div class='contentEditable' align='center'>
				                                        <a target='_blank' href='https://adoptaya.com/recuperar/?recup=".$token_recover."&mail=".$Correo."' class='link2' style='color:#ffffff;'>Recuperar contraseña</a>
				                                      </div>
				                                    </div>
				                                  </td>
				                                </tr>
